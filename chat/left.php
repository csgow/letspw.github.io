		...
		<div class="block">
			...
			<div class="menu">
				<ul>
					...
					<li><a href="/top"><?=$msg['top_winner'] ?></a></li>
					<li><a href="/history"><?=$msg['see_history'] ?></a></li>
						<li><a href="/about"><?=$msg['about'] ?></a></li>
						<li><a href="http://vk.com/csgolaime"><?=$msg['Vk'] ?></a></li>
					<?	
...
?>
		...
		<div class="block bonus">
			...
			<div><?=$msg['dobav'] ?><?=$msg['steamn'] ?><br><span>FIRESKINS.RU</span><br>и получи<br><div class="text">
